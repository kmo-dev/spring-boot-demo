...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Flyway Migration, Spring for Apache ActiveMQ Artemis'. As a result, your application may not work as expected.
